...
export const sendEnquiryController = async (req, res) => {
  try {
    ...
    if (!flat_id || !message) {
      return res
        .status(400)
        .json({ message: "Flat ID and message are required" });
    }
...
export const getUserEnquiriesController = async (req, res) => {
  try {
    ...
    return res
      .status(200)
      .json({ message: "Enquiries Fetch Successfully", enquiries });
  } catch (error) {
    return res.status(500).json({ message: "Something went wrong" });
  }
};
...
export const getAllEnquiriesController = async (req, res) => {
  try {
    ...
    return res
      .status(200)
      .json({ message: "All Enquiries Fetch Successfully", enquiries });
  } catch (error) {
    return res.status(500).json({ message: "Something went wrong" });
  }
};
